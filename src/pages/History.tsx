...
export default function History() {
  ...
  if (pastCycles.length === 0) {
    return (
      <div className="min-h-screen-mobile bg-gradient-warm flex items-center justify-center p-6">
  ...
  return (
    <div className="min-h-screen-mobile bg-gradient-warm p-6 space-y-4">
      <h1 className="text-3xl font-bold text-center mb-6">Your Ritual History</h1>
